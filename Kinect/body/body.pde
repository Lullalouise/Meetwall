...
void draw()
{
  ...
  dist=PVector.dist(NewLhand2d, Lhand2d);
    ...
    /* // draw the center of mass
     ...
     context.convertRealWorldToProjective(Rhand, Rhand2d);
     context.convertRealWorldToProjective(Lhand, Lhand2d);
